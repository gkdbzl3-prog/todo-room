...
{
    assert.deepEqual(getSubjectProgress("computer", 30), { total: 275, percent: 11 });
    assert.deepEqual(getSubjectProgress("computer", 0), { total: 275, percent: 0 });
    assert.deepEqual(getSubjectProgress("computer", 500), { total: 275, percent: 100 });
